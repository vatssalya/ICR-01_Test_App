...
namespace NI_6001
{
    ...
    [ToolboxItem(false)]
    [TemplateData("ReadWfm", MxbFile="AI1.mxb")]
    partial class AI1Component : FiniteInputDaqComponent<AnalogMultiChannelReader, AnalogWaveform<double>[]>
    {
        ...
        /// </summary>
        public AI1Component(IContainer container)
            : this()
        {
            if (container != null)
                container.Add(this);
        ...
        public event EventHandler<AI1ComponentReadCompletedEventArgs> ReadCompleted
        {
            add
            {
    ...
    /// </summary>
    public class AI1ComponentReadCompletedEventArgs : ReadCompletedEventArgs<AnalogWaveform<double>[]>
    {
        /// <summary>
        ...
        /// </param>
        public AI1ComponentReadCompletedEventArgs(AnalogWaveform<double>[] data)
            : base(data)
        {
        }
    }
    ...
    partial class AI1Component
    {
        ...
        public event EventHandler<AI1ComponentDataReadyEventArgs> DataReady
        {
            add
            {
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class AI1ComponentDataReadyEventArgs : DataReadyEventArgs<object>
    {
        /// <summary>
        /// This member supports compatibility with code that is generated with a
        /// different timing mode and is not intended to be used directly from your code.
        /// </summary>
        public AI1ComponentDataReadyEventArgs(object data)
            : base(data)
        {
            throw new NotSupportedException("This member supports compatibility with code that is generated with a different timing mode and is not intended to be used directly from your code.");
        }
