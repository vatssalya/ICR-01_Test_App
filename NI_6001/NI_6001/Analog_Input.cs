...
namespace NI_6001
{
    ...
    [ToolboxItem(false)]
    [TemplateData("ReadWfm", MxbFile="Analog_Input.mxb")]
    partial class Analog_InputComponent : FiniteInputDaqComponent<AnalogMultiChannelReader, AnalogWaveform<double>[]>
    {
        ...
        /// </summary>
        public Analog_InputComponent(IContainer container)
            : this()
        {
            if (container != null)
                container.Add(this);
        ...
        {
            Analog_Input newTask = new Analog_Input();
        ...
        protected override void EndReadFinite(IAsyncResult result)
        {
            try
            {
                ...
                Analog_InputComponentReadCompletedEventArgs args = new Analog_InputComponentReadCompletedEventArgs(data);
        ...
        /// </param>
        protected virtual void OnReadCompleted(Analog_InputComponentReadCompletedEventArgs e)
        {
        ...
        public event EventHandler<Analog_InputComponentReadCompletedEventArgs> ReadCompleted
        {
            add
            {
    ...
    /// </summary>
    public class Analog_InputComponentReadCompletedEventArgs : ReadCompletedEventArgs<AnalogWaveform<double>[]>
    {
        /// <summary>
        ...
        /// </param>
        public Analog_InputComponentReadCompletedEventArgs(AnalogWaveform<double>[] data)
            : base(data)
        {
        }
    }
    ...
    partial class Analog_InputComponent
    {
        /// <summary>
        ...
        public event EventHandler<Analog_InputComponentDataReadyEventArgs> DataReady
        {
            add
            {
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class Analog_InputComponentDataReadyEventArgs : DataReadyEventArgs<object>
    {
        /// <summary>
        /// This member supports compatibility with code that is generated with a
        /// different timing mode and is not intended to be used directly from your code.
        /// </summary>
        public Analog_InputComponentDataReadyEventArgs(object data)
            : base(data)
        {
            throw new NotSupportedException("This member supports compatibility with code that is generated with a different timing mode and is not intended to be used directly from your code.");
        }
    ...
    public class Analog_Input : Task
    {
        public Analog_Input()
        {
            Configure();
        ...
        public virtual void Configure()
        {
            ...
            // is regenerated.
                ...
                AIChannels.CreateVoltageChannel("Dev1/ai0", "Voltage", AITerminalConfiguration.Differential, -10, 10, AIVoltageUnits.Volts);
