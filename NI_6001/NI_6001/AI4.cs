...
namespace NI_6001
{
    ...
    [ToolboxItem(false)]
    [TemplateData("ReadWfm", MxbFile="AI4.mxb")]
    partial class AI4Component : FiniteInputDaqComponent<AnalogMultiChannelReader, AnalogWaveform<double>[]>
    {
        ...
        /// </summary>
        public AI4Component(IContainer container)
            : this()
        {
            if (container != null)
                container.Add(this);
        ...
        protected override void EndReadFinite(IAsyncResult result)
        {
            try
            {
                ...
                AI4ComponentReadCompletedEventArgs args = new AI4ComponentReadCompletedEventArgs(data);
        ...
        /// </param>
        protected virtual void OnReadCompleted(AI4ComponentReadCompletedEventArgs e)
        {
        ...
        public event EventHandler<AI4ComponentReadCompletedEventArgs> ReadCompleted
        {
            add
            {
    ...
    /// </summary>
    public class AI4ComponentReadCompletedEventArgs : ReadCompletedEventArgs<AnalogWaveform<double>[]>
    {
        /// <summary>
        ...
        /// </param>
        public AI4ComponentReadCompletedEventArgs(AnalogWaveform<double>[] data)
            : base(data)
        {
        }
    }
    ...
    partial class AI4Component
    {
        ...
        public event EventHandler<AI4ComponentDataReadyEventArgs> DataReady
        {
            add
            {
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class AI4ComponentDataReadyEventArgs : DataReadyEventArgs<object>
    {
        /// <summary>
        /// This member supports compatibility with code that is generated with a
        /// different timing mode and is not intended to be used directly from your code.
        /// </summary>
        public AI4ComponentDataReadyEventArgs(object data)
            : base(data)
        {
            throw new NotSupportedException("This member supports compatibility with code that is generated with a different timing mode and is not intended to be used directly from your code.");
        }
